...
export function SecurityRedirect({
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-red-50 via-orange-50 to-amber-50 p-4 dark:from-gray-950 dark:via-red-950/20 dark:to-orange-950/20">
        ...
        <CardHeader className="space-y-6 pb-4 text-center">
          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              {!isRedirecting && (
                <div className="absolute -top-2 -right-2 rounded-full bg-gradient-to-br from-red-500 to-red-600 p-1.5 shadow-lg ring-2 ring-red-100 dark:from-red-600 dark:to-red-700 dark:ring-red-900/50">
          ...
          <div className="space-y-3">
            <div className="flex flex-col items-center justify-center gap-3">
              <h2 className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 bg-clip-text text-3xl font-bold text-transparent dark:from-gray-100 dark:via-gray-200 dark:to-gray-100">
        ...
        <CardContent className="space-y-6 pt-2">
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center justify-center">
                <div className="relative">
                  ...
                  <Badge
                    variant="outline"
                    className="animate-in zoom-in-50 relative border-2 border-orange-500 bg-gradient-to-br from-orange-50 to-orange-100 px-8 py-4 text-5xl font-bold text-orange-600 shadow-lg duration-500 dark:border-orange-400 dark:from-orange-950/50 dark:to-orange-900/50 dark:text-orange-400"
                  >
              ...
              <div className="h-3 w-full overflow-hidden rounded-full bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 shadow-inner dark:from-gray-800 dark:via-gray-700 dark:to-gray-800">
                <div
                  className="relative h-3 rounded-full bg-gradient-to-r from-orange-400 via-red-500 to-red-600 shadow-lg transition-all duration-1000 ease-linear dark:from-orange-500 dark:via-red-600 dark:to-red-700"
                  style={{
          ...
          {!isRedirecting && timeLeft > 2 && (
            <Button
              ...
              className="w-full bg-gradient-to-r from-orange-600 to-orange-500 shadow-lg transition-all hover:scale-[1.02] dark:from-orange-500 dark:to-orange-600"
              size="lg"
            >
          ...
          <Alert className="border-orange-200 bg-gradient-to-br from-orange-50/80 to-amber-50/80 shadow-md backdrop-blur-sm dark:border-orange-900/50 dark:from-orange-950/50 dark:to-amber-950/30">
