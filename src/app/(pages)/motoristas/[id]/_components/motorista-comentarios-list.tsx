...
interface MotoristaComentariosListProps {
  comentarios: ComentarioResponseDTO[]
  motoristaId: string
}

export function MotoristaComentariosList({
  comentarios,
  motoristaId
}: MotoristaComentariosListProps) {
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Este motorista ainda não possui comentários.
          </CardDescription>
        </CardHeader>
      </Card>
    )
    ...
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Avaliações e comentários sobre este motorista
          </CardDescription>
        </CardHeader>
        <CollapsibleContent>
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <ComentarioActionsMenu
                        ...
                        revalidationContext={{ motoristaId }}
                      />
                    </div>
                  </div>
                ))
