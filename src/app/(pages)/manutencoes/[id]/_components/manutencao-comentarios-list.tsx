...
interface ManutencaoComentariosListProps {
  comentarios: ComentarioResponseDTO[]
  manutencaoId: string
}

export function ManutencaoComentariosList({
  comentarios,
  manutencaoId
}: ManutencaoComentariosListProps) {
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Esta oficina de manutenção ainda não possui comentários.
          </CardDescription>
        </CardHeader>
      </Card>
    )
    ...
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Avaliações e comentários sobre esta oficina de manutenção
          </CardDescription>
        </CardHeader>
        <CollapsibleContent>
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <ComentarioActionsMenu
                        ...
                        revalidationContext={{ manutencaoId }}
                      />
                    </div>
                  </div>
                ))
