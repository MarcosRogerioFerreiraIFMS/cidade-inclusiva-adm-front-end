...
import { ComentarioActionsMenu } from '@/app/_components/comentario-actions-menu'
...
interface AcessibilidadeUrbanaComentariosListProps {
  comentarios: ComentarioResponseDTO[]
  acessibilidadeUrbanaId: string
}

export function AcessibilidadeUrbanaComentariosList({
  comentarios,
  acessibilidadeUrbanaId
}: AcessibilidadeUrbanaComentariosListProps) {
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Esta acessibilidade urbana ainda não possui comentários.
          </CardDescription>
        </CardHeader>
      </Card>
    )
    ...
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Avaliações e comentários sobre esta acessibilidade urbana
          </CardDescription>
        </CardHeader>
        <CollapsibleContent>
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <ComentarioActionsMenu
                        ...
                        revalidationContext={{ acessibilidadeUrbanaId }}
                      />
                    </div>
                  </div>
                ))
